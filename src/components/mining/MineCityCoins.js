        ...
        <div className="form-check">
          ...
          <label className="form-check-label" htmlFor="flexCheckDefault">
            ...
            <ul>
              ...
              <li>
                participation does not guarantee winning the rights to claim newly minted {symbol}
              </li>
...
// simple description, documentation link
// load last 5 blocks mining data
// develop form to allow mining
